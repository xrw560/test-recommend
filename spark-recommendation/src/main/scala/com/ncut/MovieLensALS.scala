...
/**
  ...
  * desc: 找出最受欢迎的50部电影，随机选择10部让用户即时评分，并给用户推荐50部电影
  */
object MovieLensALS {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("Get " + numRatings + " ratings from " + numUser + " users on " + numMovie + " movies.")
    ...
    println("The best model was trained with rank=" + bestRanks + ", Iter=" + bestIters + ", Lambda=" + bestLambdas + " and compute RMSE on test is " + testRmse)
